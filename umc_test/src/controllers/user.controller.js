...
import { getReview, getMission, Missioncomplete} from "../providers/user.provider.js";
...
export const completeMission = async(req,res)=>{
    console.log("미션을 완료합니다.");
    console.log(req);
    res.send(response(status.SUCCESS, await Missioncomplete(req.params.userId, req.params.missionId, req.query)))
}