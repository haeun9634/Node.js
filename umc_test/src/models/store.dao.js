...
import {insertStoreSql, confirmPhone, getStoreID, getMapStoreID, 
    ...
    confirmStore, getReviewByReviewId, getReviewByReviewIdAtFirst,getMissionByMissionId, getMissionByMissionIdAtFirst } from "./store.sql.js"
...
export const getPreviewMission = async (cursorId, size, storeId) => {
    try {
        ...
        if(cursorId == "undefined" || typeof cursorId == "undefined" || cursorId == null){
            ...
            console.log(cursorId, storeId, size);
